...
var _RateModel = __webpack_require__(6);

var _RateModel2 = _interopRequireDefault(_RateModel);

var _RateView = __webpack_require__(10);
...
new _RateView2.default({
  model: model,
  el: '#root'
});

//Historical exchange data
// model.set('id', '2018-08-09');
...
var RateModel = function (_Model) {
  ...
  _createClass(RateModel, [{
    ...
    key: 'urlRoot',
    get: function get() {
      return 'http://data.fixer.io/api/latest?access_key=76fbe668faab0686b048cf0787eef49c';
    }
  }]);
...
var _RateTmpl = __webpack_require__(11);
