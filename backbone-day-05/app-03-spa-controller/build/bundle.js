...
var _RateModel = __webpack_require__(10);

var _RateModel2 = _interopRequireDefault(_RateModel);

var _RateView = __webpack_require__(11);

var _RateView2 = _interopRequireDefault(_RateView);

var _ListView = __webpack_require__(28);
...
var MainRouter = function (_Router) {
  ...
  function MainRouter(props) {
    ...
    _this.view = null;
    _this.collection = new _backbone.Collection();
    return _this;
  }
  ...
  _createClass(MainRouter, [{
    ...
    value: function doRate(date) {
      var model = new _RateModel2.default();
      model.set('id', date);
...
var RateModel = function (_Model) {
  _inherits(RateModel, _Model);

  function RateModel() {
    _classCallCheck(this, RateModel);

    return _possibleConstructorReturn(this, (RateModel.__proto__ || Object.getPrototypeOf(RateModel)).apply(this, arguments));
  }

  _createClass(RateModel, [{
    key: 'defaults',
    value: function defaults() {
      return {
        id: 'latest',
        access_key: '76fbe668faab0686b048cf0787eef49c',
        base: 'EUR',
        to: 'JPY'
      };
    }
...
var _RateTmpl = __webpack_require__(12);

var _RateTmpl2 = _interopRequireDefault(_RateTmpl);
...
var RateView = function (_View) {
  _inherits(RateView, _View);

  function RateView(props) {
    _classCallCheck(this, RateView);

    // Model 同期イベント監視 → 最新状態の再描画
    var _this = _possibleConstructorReturn(this, (RateView.__proto__ || Object.getPrototypeOf(RateView)).call(this, props));
  ...
  _createClass(RateView, [{
    key: 'render',
    value: function render() {
      var content = (0, _RateTmpl2.default)(this.model.toJSON());
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "基準："
    + alias4(((helper = (helper = helpers.base || (depth0 != null ? depth0.base : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"base","hash":{},"data":data}) : helper)))
    + "->"
    ...
    + "："
    + alias4(container.lambda(((stack1 = (depth0 != null ? depth0.rates : depth0)) != null ? stack1.JPY : stack1), depth0))
    + "\n</div>\n";
},"useData":true});
...
var _TaskModel = __webpack_require__(29);

var _TaskModel2 = _interopRequireDefault(_TaskModel);

var _ListTmpl = __webpack_require__(30);
...
var ListView = function (_View) {
  ...
  function ListView(props) {
    ...
    _this.listenTo(_this.collection, 'add remove', function () {
      return _this.render();
    });
    return _this;
  }
