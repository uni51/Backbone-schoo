...
var MainRouter = function (_Router) {
  ...
  _createClass(MainRouter, [{
    key: 'doItem',
    value: function doItem(id) {
      (0, _backbone.$)('#root').append('<li>doItem(' + id + ')\u5B9F\u884C</li>');
      this.navigate('default', { trigger: true });
    }
  }, {
    key: 'doIndex',
    value: function doIndex() {
      (0, _backbone.$)('#root').append('<li>doIndex( )実行</li>');
    }
  }, {
    key: 'routes',
    get: function get() {
      ...
      return {
        'item/:id': function itemId(id) {
          return _this2.doItem(id);
        },
        '*default': function _default() {
          return _this2.doIndex();
        }
      };
    }
  }]);
